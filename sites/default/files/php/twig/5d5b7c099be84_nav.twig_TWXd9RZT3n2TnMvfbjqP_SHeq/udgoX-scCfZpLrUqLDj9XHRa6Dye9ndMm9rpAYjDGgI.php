...
/* @webdigitalark/nav/nav.twig */
class __TwigTemplate_d56e30e3490781d443569783e7e4610f14da07943d886c2d72278901e615f294 extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $tags = ["import" => 13, "if" => 15, "set" => 16, "block" => 32, "for" => 33, "include" => 50];
        $filters = ["merge" => 28, "escape" => 31, "join" => 46];
        $functions = ["link" => 48];
        ...
        <li class=\"";
          ...
          ";
            ...
            if (($this->getAttribute($context["item"], "is_expanded", []) && $this->getAttribute($context["item"], "below", []))) {
                // line 48
                echo "            ";
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->getLink($this->sandbox->ensureToStringAllowed(($context["title"] ?? null)), $this->sandbox->ensureToStringAllowed($this->getAttribute($context["item"], "url", [])), ["class" => twig_array_merge($this->sandbox->ensureToStringAllowed(($context["nav_link_classes"] ?? null)), [0 => "dropdown-toggle"]), "data-toggle" => "dropdown"]), "html", null, true);
                echo "
            ";
                // line 49
                if ($this->getAttribute($context["item"], "below", [])) {
                    // line 50
                    echo "              ";
                    $this->loadTemplate("@radix/dropdown/dropdown-menu.twig", "@webdigitalark/nav/nav.twig", 50)->display(twig_array_merge($context, ["items" => $this->getAttribute(                    // line 51
$context["item"], "below", [])]));
                    // line 53
                    echo "            ";
                }
    ...
    {
        return "@webdigitalark/nav/nav.twig";
    }
    ...
    {
        return array (  204 => 60,  189 => 58,  184 => 56,  181 => 55,  178 => 54,  175 => 53,  173 => 51,  171 => 50,  169 => 49,  164 => 48,  162 => 47,  158 => 46,  155 => 45,  147 => 44,  144 => 43,  142 => 40,  140 => 39,  138 => 37,  137 => 36,  135 => 34,  117 => 33,  114 => 32,  109 => 63,  105 => 61,  103 => 32,  98 => 31,  96 => 30,  93 => 29,  91 => 28,  88 => 27,  86 => 26,  84 => 25,  81 => 24,  77 => 22,  73 => 20,  71 => 19,  68 => 18,  66 => 17,  63 => 16,  61 => 15,  58 => 14,  56 => 13,);
    }
      ...
      {% for item in items %}
        ...
        <li class=\"{{ nav_item_classes|join(' ') }}\">
          {% if item.is_expanded and item.below %}
            {{ link(title, item.url, { 'class': nav_link_classes|merge(['dropdown-toggle']), 'data-toggle': 'dropdown' }) }}
            {% if item.below %}
          ...
          {% else %}
            ...
            {{ link(title, item.url, { 'class': nav_link_classes }) }}
          {% endif %}
        </li>
      {% endfor %}
    {% endblock %}
...
", "@webdigitalark/nav/nav.twig", "/Library/WebServer/Documents/test/webdigital/themes/custom/webdigitalark/src/components/nav/nav.twig");
    }
}
